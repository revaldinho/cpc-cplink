...
void add_byte_of_data_to_packet(Queue *queue, BYTE data_byte)
{
    ...
    write_byte_of_data_to_queue(queue, data_byte);
}
...
{
    write_byte_of_data_to_queue(queue, (BYTE) command_id);
    write_byte_of_data_to_queue(queue, byte1);
    write_byte_of_data_to_queue(queue, byte2);
}
...
void add_4_bytes_of_data_to_packet(Queue *queue, Command command_id, BYTE byte1, BYTE byte2, BYTE byte3)
{
    ...
    write_byte_of_data_to_queue(queue, byte1);
    write_byte_of_data_to_queue(queue, byte2);
    write_byte_of_data_to_queue(queue, byte3);
}
...
void add_5_bytes_of_data_to_packet(Queue *queue, Command command_id, BYTE byte1, BYTE byte2, BYTE byte3, BYTE byte4)
{
    ...
    write_byte_of_data_to_queue(queue, byte2);
    write_byte_of_data_to_queue(queue, byte3);
    write_byte_of_data_to_queue(queue, byte4);
}

/* add the 4 byte int to the payload of the packet */
void add_int_to_packet(Queue *queue, int value)
{
    /* format high16bit(lo/high) low16bit(lo/high) in that order */
    write_byte_of_data_to_queue(queue, (value >> 16) & 0xFF);
    write_byte_of_data_to_queue(queue, (value >> 24));
    write_byte_of_data_to_queue(queue, value & 0xFF);
    write_byte_of_data_to_queue(queue, (value >> 8) & 0xFF);
}
